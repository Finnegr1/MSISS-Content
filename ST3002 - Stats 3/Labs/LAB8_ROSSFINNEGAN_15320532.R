...
setwd("C:/Users/Ross/Documents/MSISS/ThirdYear/ST3002 - Stats 3")
...
boxplot(data$Claim_Count ~ data$Vehicle_Use, col = "bisque", main = "Number of Claims by Vehicle Use", ylab ="Number of Claims", xlab = "Age Groups")
boxplot(newtat$Predicted_Count ~ data$Vehicle_Use, col = "lightblue", main = "Predicted Number of Claims by Vehicle Use", ylab ="Number of Claims", xlab = "Age Groups")

?subset
bus = subset(data, data$Vehicle_Use == "Business")
c = newtat[-c(1:24),]
